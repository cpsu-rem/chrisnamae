...
const GroceriesProducts = () => {
  ...
  return (
    <section id="groceries-products" className="py-16 px-6">
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold text-center mb-10">Groceries Products</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          {products.length === 0 ? (
            <p className="text-center text-gray-600">Loading groceries products...</p>
          ) : (
